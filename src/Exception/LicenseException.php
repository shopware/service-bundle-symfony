...
class LicenseException extends \Exception
{
    ...
    public const ERROR_LICENSE_NOT_FOUND = 1002;
    public const ERROR_LICENSE_EXPIRED = 1003;
    ...
    public static function licenseNotFound(string $shopId): self
    {
        return new self(sprintf('License key not found for shop "%s"', $shopId), self::ERROR_LICENSE_NOT_FOUND);
    }
}
